...
/**
 * Restores a BlockStar Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The BlockStar Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "BlockStar Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
