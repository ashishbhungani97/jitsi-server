BlockStar Meet - redux state persistence
====================================
BlockStar Meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, BlockStar Meet will automatically persist these subtrees and
