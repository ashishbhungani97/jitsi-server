...
/**
 * The react-native side of BlockStar Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by BlockStar Meet to
     *        a conference call.
     * @param handle - a call handle which by default is BlockStar Meet room's URL.
