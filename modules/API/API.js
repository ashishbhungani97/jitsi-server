 ...
 * interface to access BlockStar Meet features by external applications that embed
 * BlockStar Meet.
 */
class API {
    _enabled: boolean;
     ...
     * information from external applications that embed BlockStar Meet. It also
