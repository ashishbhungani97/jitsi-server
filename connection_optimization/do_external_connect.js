 ...
 * in external_connect.js for BlockStar Meet. Parses the room name and JSON Web
 * Token (JWT) from the URL and executes createConnectionExternally.
 *
 * NOTE: If you are using lib-jitsi-meet without BlockStar Meet, you should use this
 * file as reference only because the implementation is BlockStar Meet-specific.
 *
